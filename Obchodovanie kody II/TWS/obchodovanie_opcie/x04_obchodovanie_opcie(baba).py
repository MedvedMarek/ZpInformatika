...
vlakno = 104  # vlakno je potrebne mat rozne  pri viacerych otvorenych suboroch tws <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
burza = 'BABA' # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
strike_ceny = [60, 63, 64, 65, 66, 67, 67.5, 68, 69, 70, 71, 72, 72.5, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 82.5, 83, 84, 85, 86, 87, 88, 90] # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

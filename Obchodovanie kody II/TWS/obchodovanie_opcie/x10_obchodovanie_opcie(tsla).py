...
vlakno = 110  # vlakno je potrebne mat rozne  pri viacerych otvorenych suboroch tws <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
burza = 'TSLA' # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
strike_ceny = [165, 166.67, 167.5, 170, 172.5, 173.33, 175, 177.5, 180, 182.5, 183.33, 185, 186.67, 187.5, 190, 192.5, 193.33, 195, 197.5, 200, 202.5, 205, 206.67, 207.5, 210] # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

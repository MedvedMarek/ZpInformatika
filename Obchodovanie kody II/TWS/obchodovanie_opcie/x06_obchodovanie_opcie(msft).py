...
vlakno = 106  # vlakno je potrebne mat rozne  pri viacerych otvorenych suboroch tws <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
burza = 'MSFT' # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
strike_ceny = [425, 427.5, 430, 432.5, 435, 437.5, 440. , 442.5, 445. , 447.5, 450. , 452.5, 455. , 457.5, 460. , 462.5, 465. , 467.5, 470. , 472.5, 475. , 477.5, 480. , 482.5, 485. , 487.5] # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

...
class Bot:
  ...
  def __init__(self):
    ...
    self.data = {8:self.x8, 9:self.x9, 10:self.x10,11:self.x11, 12:self.x12, 13:self.x13, 14:self.x14, 15:self.x15}
    
    self.nazov_burzy = {8:'EDGEA', 9:'IEX', 10:'MEMX', 11:'NYSE', 12:'PSX', 13:'SMART', 14:'PEARL', 15:'ISLAND'}

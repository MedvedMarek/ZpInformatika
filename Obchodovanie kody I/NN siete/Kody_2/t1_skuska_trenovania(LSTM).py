...
x2 = layers.Dense(3000,activation='elu')(x1)
x3 = layers.Dense(1000,activation='elu')(x2)
x4 = layers.Dense(100,activation='elu')(x3)
vystup = layers.Dense(1)(x4)

model = Model(vstup, vystup)

model.summary()
model.compile(optimizer='nadam', loss='mse')
# history = model.fit(train,steps_per_epoch=128,epochs=10,validation_data=val,validation_steps=21)

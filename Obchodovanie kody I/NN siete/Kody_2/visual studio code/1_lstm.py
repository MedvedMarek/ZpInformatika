...
# b1 = layers.BatchNormalization()(vstup)
x1 = layers.LSTM(250, return_sequences=True, unroll=False, stateful=True)(vstup)

# b2 = layers.BatchNormalization()(x1)
x2 = layers.LSTM(250, return_sequences=True, unroll=False, stateful=True)(x1)

# b3 = layers.BatchNormalization()(x2)
x3 = layers.LSTM(250, return_sequences=True, unroll=False, stateful=True)(x2)

x = layers.Add()([x1,x2,x3])
x = layers.TimeDistributed(layers.Dense(200, activation='elu'))(x)

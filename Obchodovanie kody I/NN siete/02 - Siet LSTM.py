...
model.add(layers.TimeDistributed(layers.Dense(delay)))

model.compile(optimizer='adam', loss='mae')
history = model.fit(train,steps_per_epoch=200,epochs=5,validation_data=val,validation_steps=(100000-lookback)/batch_size)
model.save_weights('/home/marek/Dropbox/Programovanie kody/RStudio/Obchodovanie kody/NN siete/Vahy/02 - Siet LSTM (02 subor)/vahy', save_format='tf')
# model.load_weights('/home/marek/Dropbox/Programovanie kody/RStudio/Obchodovanie kody/NN siete/Vahy/02 - Siet LSTM (02 subor)/vahy')
